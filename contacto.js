document.addEventListener('DOMContentLoaded', () => {
  ...
  // 2. Copiar correo al portapapeles (Protegido)
  ...
  if (copyBtn && emailText) {
    copyBtn.addEventListener('click', () => {
      ...
      navigator.clipboard.writeText(email).then(() => {
        ...
        copyBtn.style.backgroundColor = '#22c55e'; // Verde de confirmación
  ...
  // 3. Animación de scroll (Protegido)
  ...
  // 4. Partículas animadas (SÓLO si existe el canvas #particles)
